        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card" style="background-color: #333333;margin-top: 12%">
                    <div class="card-header text-white" style="font-size: 17px">{{ __('بازگرداندن رمز عبور جدید') }}</div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                                           value="{{ $email ?? old('email') }}" required autocomplete="email" placeholder="لطفا ایمیل خود را وارد نمایید"  autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror"
                                           name="password" required autocomplete="new-password" placeholder="لطفا رمز عبور جدید خود را وارد نمایید" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" class="form-control" name="password_confirmation"
                                           required autocomplete="new-password" placeholder="لطفا تکرار رمز عبور جدید خود را وارد نمایید" >
                                </div>
                            </div>
