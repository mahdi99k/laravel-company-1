...
@section('title' , 'صفحه به روزرسانی اسلایدر')
    ...
    <section class="data">
        ...
        <section class="row m-0">
            <section class="col-8 offset-2 jumbotron bg-secondary text-white p-4 mt-5 text-right" style="direction: rtl">
                <h3 class="text-center mb-4" style="color: #4bffc1">صفحه ی به روزرسانی اسلایدر</h3>
                ...
                <section class="form-group">
                    ...
                    <p class="text-center"><img src="{{ asset("assets/images/slider/$slider->image") }}" width="150" height="100"></p>
                </section>
                @error('image')
                <p class="text-warning text-right">{{ $message }}</p>
                @enderror
                ...
                <section class="form-group">
                    {!! Form::submit('به روزرسانی اسلایدر' , ['class' => 'btn btn-success btn-block mt-5']) !!}
                </section>
