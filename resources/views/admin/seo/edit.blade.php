...
@section('title' , 'صفحه به روزرسانی سئو')
    ...
    <section class="data">
        ...
        <section class="row m-0">
            <section class="col-8 offset-2 jumbotron bg-secondary text-white p-4 mt-5 text-right"
                     style="direction: rtl">
                <h3 class="text-center text-warning mb-4">صفحه ی به روزرسانی سئو</h3>
                ...
                {!! Form::submit('به روزرسانی سئو' , ['class' => 'btn btn-success btn-block mt-5']) !!}
