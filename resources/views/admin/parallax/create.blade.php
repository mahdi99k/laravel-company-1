...
@section('title' , 'صفحه ساخت پارالکس')
    ...
    <section class="data">
        ...
        <section class="row m-0">
            <section class="col-8 offset-2 jumbotron bg-secondary text-white p-4 mt-5 text-right"
                ...
                <h3 class="text-center mb-4" style="color:aqua">صفحه ی ایجاد پارالکس</h3>
                ...
                {!! Form::select('titleSize' , [14 => '14' ,16 => '16' ,18 => '18' ,20 => '20' ,22 => '22',24 => '24' ,26 => '26',28 => '28'
                    ,30 => '30', 32 => '32' , '34' => 34] , 14 ,['class' => 'form-control mb-4' , 'style' => 'border:2px inset lightgray']) !!}
                @error('titleSize')
                <p class="text-warning text-right">{{ $message }}</p>
                @enderror
                ...
                {!! Form::color('titleColor', old('titleColor'), ['class' => 'form-control mb-4' , 'style' => 'border:2px inset lightgray']) !!}
                @error('titleColor')
                <p class="text-warning text-right">{{ $message }}</p>
                @enderror
                ...
                {!! Form::select('bodySize' , [14 => '14' ,15 => '15' ,16 => '16' ,17 => '17' ,18 => '18',19 => '19' ,20 => '20',21 => '21'
                    ,22 => '22'] , 14 ,['class' => 'form-control mb-4' , 'style' => 'border:2px inset lightgray']) !!}
                @error('bodySize')
                <p class="text-warning text-right">{{ $message }}</p>
                @enderror
                ...
                {!! Form::color('bodyColor', old('bodyColor'), ['class' => 'form-control mb-4' , 'style' => 'border:2px inset lightgray']) !!}
                @error('bodyColor')
                <p class="text-warning text-right">{{ $message }}</p>
                @enderror
                ...
                {!! Form::submit('ساخت پارالکس' , ['class' => 'btn btn-success btn-block mt-5']) !!}

                {!! Form::close() !!}

                <a href="{{ route('parallax.index') }}" class="btn btn-primary text-light mt-3">برو به صفحه نمایش
                    پارالکس</a>
